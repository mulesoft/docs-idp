...
Analyze non-standard documents and fully customize the output structure by using the Generic document action with Einstein. You can define fields and tables in the output structure and configure prompts for Einstein to analyze the document and extract the data.  
