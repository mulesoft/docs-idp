...
If you need to fully customize the output of a document, use the Generic action with Einstein, which enables you to add fields and tables to the output document and configure prompts for Einstein to analyze the document and extract the data from your documents.  
