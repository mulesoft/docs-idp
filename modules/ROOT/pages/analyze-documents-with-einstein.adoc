...
By default, IDP uses Natural Language Processing (NLP) to extract data from documents. You can enable Einstein for your organization and use Einstein AI to analyze semi-structure or unstructured documents with complex data and extract values.
