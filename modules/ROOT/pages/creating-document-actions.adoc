...
You can click *Focus* (image:focus-icon.png["Small circular icon with a crosshair or target symbol, used to indicate a focus or targeting action in the UI", 2%, "The Focus icon"]) to center the preview in the corresponding field.
--
