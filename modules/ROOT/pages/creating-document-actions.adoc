...
+
--
** *Visibility*: defines if this field shows in the output JSON result. Click *Visibility* (image:visibility-icon.png["Eye icon with an open eye design, used to represent visibility or show/hide toggle functionality", 2%, 2%]) to hide this field. 
...
You can click *Focus* (image:focus-icon.png["Small circular icon with a target/crosshair symbol, used to indicate a focus or targeting action in the UI", 2%, 2%]) to center the preview in the corresponding field.
--
