...
* Example document
+
image::timesheet-examples.png["Timesheet record showing fields for employee name, project, hours worked per day, total hours, and approval status", 50%, "An example of a timesheet record."]
...
* Example document
+
image::medical-license-handwriting-example.png[50%, 50%, "An example medical license that includes key-value pairs and handwriting."]
