...
* Example document
+
image::timesheet-examples.png["Timesheet record table showing employee name, date, project, task description, hours worked, and status columns with sample data rows", 50%, 50%]
