...
For more information on usage and pricing metrics, see xref:access-management::pricing-metrics.adoc#metrics-collected-in-anypoint-platform[Metrics Collected in Anypoint Platform].
