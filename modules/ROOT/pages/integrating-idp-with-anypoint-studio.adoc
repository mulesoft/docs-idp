...
:keywords: intelligent document processing, anypoint studio, idp runtime service api connector, submit document, retrieve execution results, idp integration
...
+
--
** US East (Virginia): `idp-rt.us-east-1.anypoint.mulesoft.com`
** EU Central (Frankfurt): `idp-rt.eu-central-1.eu1.anypoint.mulesoft.com`
--
