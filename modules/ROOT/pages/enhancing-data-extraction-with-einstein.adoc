...
To analyze any type of document with Einstein, fully customize the output structure, and optimize Einstein credit consumption, see xref::analyzing-documents-with-einstein.adoc[].
