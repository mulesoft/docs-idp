...
To analyze a non-standard document with Einstein and fully customize the output fields and tables, see xref::enhancing-data-extraction-with-einstein.adoc[].
