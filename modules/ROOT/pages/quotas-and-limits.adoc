...
* 120,000 characters per request for Einstein prompts. 
+
...
** //TBC
+  
For the Generic document action with *Customize Schema* enabled, the total input limit is 20,000 characters, considering all field, table, column names, and their corresponding intructions. 
