...
* When using Einstein and *Customize Schema* is disabled: (300 / number of Einstein prompts in document action) requests per minute.
* 100 concurrent IDP executions per minute.
| Document Languages 
a| 
