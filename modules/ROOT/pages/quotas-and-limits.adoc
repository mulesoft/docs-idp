...
+
For the Generic document action with Einstein, the total input limit is 20,000 characters, considering all field, table, column names, and their corresponding intructions. 
