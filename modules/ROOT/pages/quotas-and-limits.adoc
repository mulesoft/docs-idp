...
* https://cloud.google.com/vertex-ai/generative-ai/docs/multimodal/image-understanding#image-requirements[Gemini: token usage estimation for images]
* https://platform.openai.com/docs/guides/images-vision?api-mode=chat[OpenAI: token usage estimation for images]
