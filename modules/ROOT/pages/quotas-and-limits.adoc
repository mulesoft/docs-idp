...
For a list of supported regions and their corresponding API endpoints, see xref:automate-document-processing-with-the-idp-api.adoc#_supported_regions[Supported Regions].
