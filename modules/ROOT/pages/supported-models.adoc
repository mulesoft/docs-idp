...
a| * Low credit consumption
   * Medium accuracy on reading checkboxes in forms when processing one page at a time
 | ~6,000 words
a|  * Currently, the Gemini model doesn't show an accurate confidence score and is set to 80% by default.
