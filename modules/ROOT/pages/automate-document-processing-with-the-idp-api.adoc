...
Because RPA integrates seamlessly with IDP, you can execute document actions from your automations without configuring a Connected App. After you publish a document action, RPA can interact with it by using the Send Document and Retrieve Results action steps.
