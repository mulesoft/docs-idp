...
* `confidenceScore`: The confidence level of the extracted value (0-100)
* `geometry`: The position and dimensions of the field on the page
...
* `pageNumber`: The page number where the field was found

If *Location callouts* is disable, the geometry is `null`.

The following example is a fragment of a response that shows the additional information.
[source,json]
----
...
"fields": {
