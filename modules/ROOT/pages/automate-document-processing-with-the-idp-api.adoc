...
When you set `valueOnly=false`, the response includes the following additional information for each extracted field:
...
.Example response with `valueOnly=false`.
[source,json]
----
{
  "id": "df3445ca-05c7-4eea-a014-aaf18cd98e8c",
  "documentName": "invoice.pdf",
  "status": "MANUAL_VALIDATION_REQUIRED",
  "fields": {
    "total": {
      "value": "37.50",
      "confidenceScore": 88.95605,
      "geometry": {
        "width": 0.034,
        "height": 0.014,
        "left": 0.733,
