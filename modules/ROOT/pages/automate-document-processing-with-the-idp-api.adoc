...
=== Configure a Different Salesforce Org to Call the API

If you have multiple Salesfore Orgs connected with your Anypoint Platform organization, you can specify the Org to use when making the API call to IDP.
